define(['jquery', 'TYPO3/CMS/Backend/Icons', 'TYPO3/CMS/T3events/leaflet-core-1.4.0'], function ($, Icons) {
    'use strict';
    ...
    $(function () {
        ...
        Icons.getIcon('actions-close', Icons.sizes.small).done(function (actionsClose) {
            ...
            $('body').append(
                ...
                '<div class="btn-group"><a href="#" class="btn btn-icon btn-default" title="' + LeafBE.$labelClose + '" id="t3js-t3events-close-map">' +
                LeafBE.$iconClose +
                '</a>' +
                '<a class="btn btn-default" href="#" title="Import marker position to form" id="t3js-t3events-import-position">' +
                LeafBE.$labelImport +
                '</a></div>' +
                LeafBE.$labelTitle +
                '</div>' +
        ...
        function createMap() {
            ...
            $('#t3js-t3events-import-position').on('click', function () {
            ...
            $('#t3js-t3events-close-map').on('click', function () {
                $('#t3js-location-map-wrap').removeClass('active');
            });
        }
