...
$TCA['tx_t3events_domain_model_eventtype'] = array(
	'ctrl' => $TCA['tx_t3events_domain_model_eventtype']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'title' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:t3events/Resources/Private/Language/locallang_db.xml:tx_t3events_domain_model_eventtype.title',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
