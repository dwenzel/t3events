...
/**
 * Test case for class \Webfox\T3events\Domain\Repository\PersonRepository.
 *
 * @author Dirk Wenzel <dirk.wenzel@cps-it.de>
 * @coversDefaultClass \Webfox\T3events\Domain\Repository\PersonRepository
 */
class PersonRepositoryTest extends UnitTestCase {

	/**
	 * @var \Webfox\T3events\Domain\Repository\PersonRepository
	 */
	protected $fixture;
