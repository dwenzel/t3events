...
class PeriodConstraintRepositoryTraitTest extends UnitTestCase {
	...
	public function setUp() {
		...
		$this->demand = $this->getMock(
			...
			[
				'getPeriod', 'setPeriod', 'getPeriodStart',
				'setPeriodStart', 'getPeriodType', 'setPeriodType',
				'getPeriodDuration', 'setPeriodDuration',
				'getStartDate', 'getEndDate', 'getStartDateField',
				'getEndDateField'
			]
		);
	}
