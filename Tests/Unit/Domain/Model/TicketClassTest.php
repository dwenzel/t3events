...
/**
 * Test case for class Tx_T3events_Domain_Model_TicketClass.
 *
 * @version $Id$
 ...
 */
class Tx_T3events_Domain_Model_TicketClassTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_T3events_Domain_Model_TicketClass
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_T3events_Domain_Model_TicketClass();
	}
