 ...
 ***************************************************************/
  ...
  */
 class Tx_T3events_Domain_Model_TeaserDemandTest extends Tx_T3events_Domain_Model_AbstractDemandTest {
	/**
	 * @var Tx_T3events_Domain_Model_TeaserDemand
	 */
	protected $fixture;
	
	public function setUp(){
		$this->fixture = new Tx_T3events_Domain_Model_TeaserDemand();
	}
